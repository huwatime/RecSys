...
parser.add_argument('-f', dest='files', metavar='file', type=str, nargs='+',
        help='The path(s) of the rating file(s). If multiple files are \
                specifiled, they will be treated as split files and be \
                applied directly to k-fold evaluation manner, where k \
                euqals the number of files you specifiled.')
parser.add_argument('-k', dest='ks', metavar='K', type=int, nargs='+',
        help='The value of K(s) of the evaluation matrics P@K, R@K, etc')
